...
public class GeneralClientData {
    ...
    @SerializedName("city")
    @Expose
    private GeneralResponseData2 city;
    @SerializedName("blood_type")
    @Expose
    private GeneralResponseData2 bloodType;



    @SerializedName("governorate")
    @Expose
    private GeneralResponseData2 governorate;
    ...
    public GeneralResponseData2 getCity() {
        return city;
    }

    public void setCity(GeneralResponseData2 city) {
        this.city = city;
    }

    public GeneralResponseData2 getBloodType() {
        return bloodType;
    }

    public void setBloodType(GeneralResponseData2 bloodType) {
        this.bloodType = bloodType;
    }

    public GeneralResponseData2 getGovernorate() {
        return governorate;
    }

    public void setGovernorate(GeneralResponseData2 governorate) {
