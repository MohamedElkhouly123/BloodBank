...
package com.example.bloodbank.model.login;

import com.example.bloodbank.model.register.RegisterCity;
...
public class LoginClient {
    ...
    @Expose
    private RegisterCity bloodType;
    ...
    public RegisterCity getBloodType() {
        return bloodType;
    }

    public void setBloodType(RegisterCity bloodType) {
